...
function updateCountdown() {
    var dynamicCountdownDate = getDynamicCountdownDate();

    if ($('.time-countdown').length) {
        $('.time-countdown').each(function() {
            var $this = $(this);
            $this.countdown(dynamicCountdownDate, function(event) {
...
// Call the updateCountdown function periodically or in response to changes in the dynamic date source
updateCountdown();
